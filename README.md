...
BSL-1.1 (engine) · MIT (ecosystem) · Python 3.12 · SQLite · ONNX · [getflex.dev](https://getflex.dev) · [github](https://github.com/damiandelmas/flex) · [x](https://x.com/damian_delmas)
